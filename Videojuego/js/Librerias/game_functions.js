...
function addPlatform(x, y, width, height, lst, unit, hostil, sprite, widthSprite, heightSprite, type) {
    ...
    //Set the correct paltform sprite according to the card
    ...
    //Set the correct paltform sprite according to the autogenerated platform and actual game difficulty
    box.setSprite(`../Videojuego/assets/sprites/plataformas_auto/${sprite}_${gameConfig.actualDiff}.png`,
                            new Rect(widthSprite, 0, widthSprite, heightSprite));
    }
    box.destroy = false;
    box.hostil = hostil;
    lst.push(box);
...
//Function to add a card in the invetory of the player
